...
# Command: .stop - stop auto reaction
@client.on(events.NewMessage(pattern=r'^\.stop(?:\s|$)', func=lambda e: True))
async def stop_handler(event):
    ...
    if react_task:
        react_task.cancel()
        react_task = None
        await event.reply("Auto reaction stopped.")
    else:
        await event.reply("No auto reaction running.")
